...
class Other(commands.Cog):
    ...
    @commands.command(
        name='latency',
        description='Returns latency between the bot and the Discord servers'
    )
    ...
    @commands.command(
        name='choose',
        description='Picks a random alternative from given space separated options'
    )
    ...
    @commands.command(
        name = "remindme",
        description="Set up a reminder in given amount of time"
    )
    ...
    @commands.command(
        name='credits',
        description='Show development team behind this magnificent bot'
    )
